...
def pegar_cotacao():
    ...
    dia = data_cotacao[:2]
    link = f"https://economia.awesomeapi.com.br/json/daily/{moeda}-BRL/30?start_date={ano}{mes}{dia}&end_date={ano}{mes}{dia}"
...
def atualizar_cotacoes():
    try:
        ...
        for moeda in moedas:
            link = f"https://economia.awesomeapi.com.br/json/daily/{moeda}-BRL/30?" \
